...
class ActionComposeeTest {
    ...
    void testCreationActionComposeeShouldNotWork() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class,()->{
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1,ACTION_LIST_WITH_1_ACTION,FRACTION_LIST_WITH_ONE_FRACTION);
        });

        Assertions.assertThrows(IllegalArgumentException.class,()->{
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1,DEFAULT_LIST_ACTIONS,FRACTION_LIST_WITH_ONE_FRACTION_ABOVE_1);
        });
        ...
        Assertions.assertThrows(IllegalArgumentException.class,()->{
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1,DEFAULT_LIST_ACTIONS,FRACTION_LIST_WITH_SUM_EQUAL_ONE_BUT_INVALID_FRACTION);
        });
    ...
    void testVisualiserActionComposeeShouldWork() {
        ActionComposee actionComp = new ActionComposee(DEFAULT_ACTION_NAME1, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        ...
        ActionComposee actionCompJour = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, List.of(action1, action2), FRACTION_LIST_WITH_2_FRACTIONS);
    ...
    void testEqualsTransitive() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        ActionComposee action2 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        ActionComposee action3 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
    ...
    void testEqualsDifferentClass() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        Assertions.assertNotEquals(DEFAULT_ACTION_NAME2, action1, "An object should not be equal to an object of a different class");
    }
