...
class ActionComposeeTest {
    ...
    private static final String DEFAULT_COMPOSED_ACTION_NAME1 = "Action composée Test";
    private static final String DEFAULT_COMPOSED_ACTION_NAME2 = "Action composée Test 2";

    private static final List<ActionSimple> DEFAULT_LIST_ACTIONS = List.of(new ActionSimple(DEFAULT_ACTION_NAME1),
            new ActionSimple(DEFAULT_ACTION_NAME2), new ActionSimple(DEFAULT_ACTION_NAME3));
    private static final List<ActionSimple> ACTION_LIST_WITH_1_ACTION = List.of(new ActionSimple(DEFAULT_ACTION_NAME1));
    private static final List<ActionSimple> ACTION_LIST_WITH_2_ACTIONS = List.of(new ActionSimple(DEFAULT_ACTION_NAME1),
            new ActionSimple(DEFAULT_ACTION_NAME2));

    private static final List<Float> DEFAULT_LIST_FRACTIONS1 = List.of(0.3F, 0.3F, 0.4F);
    private static final List<Float> DEFAULT_LIST_FRACTIONS2 = List.of(0.2F, 0.3F, 0.5F);
    ...
    void testCreationActionComposeeShouldWork() {
        Assertions.assertDoesNotThrow(() -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        });
    }
    ...
    void testCreationActionComposeeShouldNotWork() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee("", DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(null, DEFAULT_LIST_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, ACTION_LIST_WITH_2_ACTIONS, DEFAULT_LIST_FRACTIONS1);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, FRACTION_LIST_WITH_2_FRACTIONS);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, ACTION_LIST_WITH_1_ACTION,
                    FRACTION_LIST_WITH_ONE_FRACTION);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                    FRACTION_LIST_WITH_ONE_FRACTION_ABOVE_1);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS, FRACTION_LIST_WITH_SUM_ABOVE_1);
        });

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                    FRACTION_LIST_WITH_SUM_EQUAL_ONE_BUT_INVALID_FRACTION);
        });
    ...
    void testVisualiserActionComposeeShouldWork() {
        ActionComposee actionComp = new ActionComposee(DEFAULT_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        ...
        ActionComposee actionCompJour = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, List.of(action1, action2),
                FRACTION_LIST_WITH_2_FRACTIONS);
    ...
    void testEqualsReflexive() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
    ...
    void testEqualsSymmetric() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        ActionComposee action2 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
    ...
    void testEqualsTransitive() {
        ...
        ActionComposee action2 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        ActionComposee action3 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
    ...
    void testEqualsDifferentClass() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        Assertions.assertNotEquals(DEFAULT_ACTION_NAME2, action1,
    ...
    void testEqualsDifferentLibelle() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        ActionComposee action2 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME2, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
    ...
    void testEqualsDifferentActions() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        ActionComposee action2 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, ACTION_LIST_WITH_2_ACTIONS,
                FRACTION_LIST_WITH_2_FRACTIONS);
    ...
    void testEqualsDifferentFractions() {
        ActionComposee action1 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        ActionComposee action2 = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS2);
        Assertions.assertNotEquals(action1, action2, "Actions with different fractions should not be equal");
    }

    @Test
    void testHashCodeConsistency() {
        ActionComposee action = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
    ...
    void testHashCodeDifferentForDifferentObjects() {
        ...
        // This test just ensures that hashCodes are not always the same for different
        // objects
    ...
    void testEqualsDifferentClassObject() {
        ActionComposee action = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        Assertions.assertFalse(action.equals(DEFAULT_ACTION_NAME1),
    ...
    void testEqualsWithDifferentClass() {
        ActionComposee action = new ActionComposee(DEFAULT_COMPOSED_ACTION_NAME1, DEFAULT_LIST_ACTIONS,
                DEFAULT_LIST_FRACTIONS1);
        Assertions.assertFalse(action.equals(DEFAULT_COMPOSED_ACTION_NAME2),
                "equals should return false when compared to a different class");
    }
